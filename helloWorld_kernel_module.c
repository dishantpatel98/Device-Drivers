...
int x=5;//this will be allocated in the data region of the memory
char*str1=NULL;
int *ptr=0x0000000a;
char *p2=NULL;
struct page*p1=NULL;
...
printk(KERN_ALERT "Module Is loaded");    ///printk() function is defined in the linux  kernel and made available to modules,it behaves similarly
